...
officials <- Dict$new(
  ...
  LesEchos = c("LesEchos"),
  LOpinion = c("lopinion_fr"),
  JDD = c("leJDD"),
  LaTribune = c("LaTribune"),
  LHumanite = c("humanite_fr"),
  Atlantico = c("atlantico_fr"),
  RTL = c("RTLFrance", "RTLSoir"),
  RMC = c("rmcinfo", "RMCStorytv"),
  SudRadio = c("SudRadio"),
  FranceCulture = c("franceculture"),
  Arte = c("ARTEfr"),
  France5 = c("France5tv"),
  TF1 = c("TF1"),
  C8 = c("C8", "TPMP"),
  France2 = c("france2tv", "QuelleEpoqueOff"),
  France3 = c("France3tv"),
  M6 = c("M6"))
